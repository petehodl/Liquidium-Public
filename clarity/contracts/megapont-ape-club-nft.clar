...
;;live (impl-trait 'SP2PABAF9FTAJYNFZH93XENAJ8FVY99RRM50D2JG9.sip009-nft-trait.sip009-nft-trait)
;;test (impl-trait 'ST1HTBVD3JG9C05J7HBJTHGR0GGW7KXW28M5JS8QE.sip009-nft-trait.sip009-nft-trait)
...
;; Set base uri
(define-private (set-base-uri (new-base-uri (string-ascii 80)))
  (begin
